...
dotenv.config();
const { REDIS_HOST = '127.0.0.1', REDIS_PORT = '6379', REDIS_PASSWORD, REDIS_DB = '0', REDIS_CHANNEL = 'notifications', LARAVEL_API_BASE_URL = 'http://localhost:8000', MAX_RETRY_ATTEMPTS = '3', PORT = '3000', } = process.env;
const redisOptions = {
    host: REDIS_HOST,
...
const service = new NotificationService(repo, redisPub, LARAVEL_API_BASE_URL, REDIS_CHANNEL, Number(MAX_RETRY_ATTEMPTS));
...
async function startSubscriber() {
    redisSub.on('notifications', (_ch, msg) => service.handleMessage(msg));
